<?php 
  include('config.php');
  $kode = $_GET ['kode'];
   $sql = mysql_fetch_array(mysql_query("SELECT * from ekskul_keilmuan where kode_ekskul='$kode'"));
  if($_SESSION['username'] == "admin"){
    ?>
    <div class="form-style-10">
      <h1>EDIT EKSTRAKULIKULER KEILMUAN<span>Silahkan isi form di bawah ini untuk mengedit Ekskul Keilmuan !</span></h1>
      <form method="post" action="proses_edit_ekskul.php?kode=ekskul_keilmuan&eks=<?php echo $sql['kode_ekskul'] ; ?>" enctype="multipart/form-data">
