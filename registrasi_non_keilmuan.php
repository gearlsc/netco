...
$record = "registrasi_non_keilmuan.php";
...
<h1>Pendaftaran Ekstrakulikuler Non Keilmuan NETCO<span>Silahkan isi form di bawah ini !</span></h1>
<form method="post" action="proses_registrasi.php?kode=<?php echo $record;?>">
    ...
    <div class="inner-wrap">
        ...
        <label>Ekskul<input type="text" name="ekskul" value="Ekstrakulikuler Non Keilmuan" readonly></label>
        <label>Jenis Ekskul
