<?php 
  ...
  if($_SESSION['username'] == "admin"){
    ...
    <div class="form-style-10">
      <h1>TAMBAH EKSTRAKULIKULER KEILMUAN<span>Silahkan isi form di bawah ini untuk menambah Ekskul Keilmuan !</span></h1>
      <form method="post" action="proses_tambah_ekskul.php?kode=ekskul_keilmuan" enctype="multipart/form-data">
